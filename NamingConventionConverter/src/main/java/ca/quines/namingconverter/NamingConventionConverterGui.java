...
public class NamingConventionConverterGui extends Dialog {
    ...
    public void open() {
        ...
        // 2. Fixed Middle Section: Undo Button
        ...
        // 3. Bottom Section: Tab Folder for Categories
        ...
        createRegexContent(regexGroup, shell);
    ...
    private void createRegexContent(Composite parent, Shell shell) {
